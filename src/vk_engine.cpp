...
void VulkanEngine::load_images() {
  ...
  vkutil::load_image_from_file(*this, "./models/lost_empire-RGBA.png",
                               lostEmpire.image);
...
void VulkanEngine::load_meshes() {
  // load the monkey
  Mesh mainObj{};
  mainObj.load_from_obj("./models/lost_empire.obj");
...
void VulkanEngine::init_scene() {
  ...
  mainObj.material = get_material("texturedmesh");
  ...
  imageBufferInfo.imageView = _loadedTextures["texturedmesh"].imageView;
